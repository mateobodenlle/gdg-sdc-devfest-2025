  ...
  return formState === 'error' ? (
    ...
    <form
      ...
      onSubmit={e => {
        ...
        const windowTop = (window.top as Window).outerHeight / 2 + (window.top as Window).screenY - 700 / 2;
        const windowLeft = (window.top as Window).outerWidth / 2 + (window.top as Window).screenX - 600 / 2;
