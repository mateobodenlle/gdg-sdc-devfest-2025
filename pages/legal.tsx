...
export default function Jobs({ jobs }: Props) {
  ...
  return (
    <Page meta={meta}>
      <Layout>
        <Header hero="Información Legal del DevFest Santiago de Compostela 2024" description="En esta página encontrarás información legal sobre el DevFest Santiago de Compostela 2024." />
...
  */}
        <div className="m-8 shadow-md border rounded-lg border-white">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              1.4 Al participar en el DevFest Santiago de Compostela 2024, los asistentes renuncian a cualquier reclamación por derechos de privacidad relacionados con la captura y uso de sus imágenes.
            </p>
            <p className="mb-4">
...
  */}
          <section className="mb-8">
            ...
            <p className="mb-4">
              En GDG Santiago de Compostela, organizadores del DevFest Santiago de Compostela 2024, estamos comprometidos con la protección de tu privacidad. Esta política de privacidad detalla cómo recopilamos, usamos, divulgamos y protegemos la información personal que puedas proporcionarnos durante el evento y en relación con él.
            </p>
            ...
            <p className="mb-4">
              1.3 Toda la información recopilada se trata con confidencialidad y se utiliza únicamente con el propósito de mejorar tu experiencia en el DevFest Santiago de Compostela 2024.
            </p>
...
  */}
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              La Política de Cookies del DevFest Santiago de Compostela 2024 describe cómo utilizamos las cookies y tecnologías similares en nuestro sitio web. Al utilizar nuestro sitio, aceptas el uso de cookies de acuerdo con esta política.
            </p>
...
  */}
          <section className="mb-8">
            ...
            <p className="mb-4">
              GDG Santiago de Compostela no será responsable de ningún daño directo, indirecto, incidental, consecuente o punitivo resultante de la participación en el DevFest Santiago de Compostela 2024, incluyendo pero no limitado a pérdida de datos, interrupciones de servicio o daños a la propiedad.
            </p>
            <p className="mb-4">
              Al registrarte y participar en el evento, aceptas liberar de responsabilidad a GDG Santiago de Compostela y a sus afiliados, patrocinadores, colaboradores y organizadores de cualquier reclamación o demanda relacionada con tu participación en el DevFest Santiago de Compostela 2024.
            </p>
            <p className="mb-4">
